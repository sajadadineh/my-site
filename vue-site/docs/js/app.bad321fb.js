(function(t) {
  function e(e) {
    for (
      var r, s, c = e[0], a = e[1], u = e[2], h = 0, d = [];
      h < c.length;
      h++
    )
      (s = c[h]),
  ...
  "56d7": function(t, e, n) {
    ...
    var r = n("2b0e"),
      ...
      i = [
        function() {
          ...
          return n("h1", [
            n(
              "a",
              { attrs: { href: "https://github.com/ndabAP/vue-command" } },
              [t._v("vue-command")]
            )
          ]);
        },
      ...
      s = function() {
        var t = this,
          ...
          n = t._self._c || e;
        return n("div", [
          t.isLoading || t.isError ? t._e() : n("span", [t._v(t._s(t.joke))]),
          t.isLoading && !t.isError ? n("span", [t._v("Loading ...")]) : t._e(),
          t.isError
            ? n("span", [t._v("There was an error getting the joke")])
            : t._e()
        ]);
      },
      c = [],
    ...
    var d = "https://api.chucknorris.io/jokes/random",
      f = 5e3,
      p = new AbortController(),
      m = {
        inject: ["terminate"],
        data: function() {
          return { isError: !1, isLoading: !0, joke: "" };
        },
        mounted: function() {
          var t = this;
          return h(
                  ...
                  while (1)
                    switch ((e.prev = e.next)) {
                      ...
                      case 4:
                        ...
                        return (
                          t.setIsError(!0), t.terminate(), e.abrupt("return")
                        );
                      case 9:
                      ...
                      case 11:
                        ...
                        break;
                      case 16:
                        (e.prev = 16), (e.t0 = e["catch"](1)), t.setIsError(!0);
                      case 19:
                        return (
                          (e.prev = 19),
                          (t.isLoading = !1),
      ...
      v = m,
      y = n("2877"),
      b = Object(y["a"])(v, s, c, !1, null, null, null),
      g = b.exports,
      x = function() {
        var t = this,
          e = t.$createElement,
        ...
        return n(
          "div",
          [
            t._l(t.characters, function(e, r) {
              return n(
                "span",
                { key: r, style: { color: t.calculateColor(r) } },
                [t._v(" " + t._s(e) + " ")]
              );
            }),
            n("br"),
            n("br"),
            t._v(" Press Ctrl + c to leave. ")
          ],
          2
        );
      },
      ...
      $ = {
        inject: ["terminate"],
        data: function() {
          return { characters: "KLIEH", index: 0, interval: void 0 };
        },
        mounted: function() {
          var t = this;
          (this.interval = setInterval(function() {
            ...
            window.addEventListener(
              ...
              function(e) {
                e.ctrlKey &&
                  e.keyCode === I &&
                  (clearInterval(t.interval), t.terminate());
              },
              !0
            );
        },
        methods: {
          calculateColor: function(t) {
            t += this.index;
            var e = Math.floor(t / O.length) * O.length;
            return O[t - e];
          }
        }
      },
      F = $,
      E = Object(y["a"])(F, x, w, !1, null, null, null),
      C = E.exports,
      A = function() {
        var t = this,
          e = t.$createElement,
          n = t._self._c || e;
        return t.context.parsed.help
          ? n("span", [
              t._v(" Options: "),
              n("br"),
              t._v(" --timeout (default: 50)"),
              n("br"),
              t._v(" --amount (default: 10) ")
            ])
          : n("span", [t._v(t._s("#".repeat(t.index)))]);
      },
      T = [],
      L = {
        inject: ["terminate"],
        ...
        mounted: function() {
          var t = this;
          if (this.context.parsed.help) this.terminate();
          else {
            var e = this.context.parsed.timeout || 50,
              n = this.context.parsed.amount || 10,
              r = function r() {
                return setTimeout(function() {
                  t.index++, t.index < n ? r() : t.terminate();
                }, e);
              };
            r();
          }
      ...
      K = L,
      H = Object(y["a"])(K, A, T, !1, null, null, null),
      B = H.exports,
      N = function() {
        var t = this,
          e = t.$createElement,
          n = t._self._c || e;
        return t.environment.isExecuting
          ? n("div", [
              n(
                "textarea",
                {
                  ...
                  on: {
                    keydown: function(e) {
                      return (e.type.indexOf("key") || 88 === e.keyCode) &&
                        e.ctrlKey
                        ? t.terminate(e)
                        : null;
                    }
                ...
                [
                  t._v(
                    "This is a Nano text editor emulator! Press Ctrl + x to leave."
                  )
                ]
              )
            ])
      ...
      q = D,
      z = (n("d962"), Object(y["a"])(q, N, M, !1, null, "f86bbe98", null)),
      V = z.exports,
      R = function() {
        var t = this,
          e = t.$createElement,
        ...
        return n(
          ...
          [
            t._t("bar", [
              t.hideBar
                ? t._e()
                : n("div", { staticClass: "term-bar" }, [
                    t.hideTitle
                      ? t._e()
                      : n("span", { staticClass: "term-title" }, [
                          t._v(" " + t._s(t.title) + " ")
                        ])
                  ])
            ]),
                  ...
                  [
                    ...
                    t._l(t.local.history, function(e, r) {
                      return n(
                        ...
                        {
                          key: r,
                          staticClass: "term-hist",
                          class: {
                            "term-hist-fullscreen":
                              t.local.isFullscreen &&
                              r === t.local.history.length - 1
                          }
                        },
                        [
                          n("stdout", {
                            ...
                            directives: [
                              {
                                ...
                                rawName: "v-show",
                                value:
                                  (0 === r && !t.local.isFullscreen) ||
                                  (!(
                                    r === t.local.history.length - 1 &&
                                    t.local.isInProgress
                                  ) &&
                                    !t.local.isFullscreen),
                                expression:
                                  "(index === 0 && !local.isFullscreen) || !(index === local.history.length - 1 && local.isInProgress) && !local.isFullscreen"
                              }
                            ],
                            ref: "stdin",
                            refInFor: !0,
              ...
              keydown: [
                function(e) {
                  return (!e.type.indexOf("key") &&
                    ...
                    e.metaKey
                    ? null
                    : (e.preventDefault(), t.setIsSearch(!1));
                },
                function(e) {
                  return (!e.type.indexOf("key") &&
                ...
                function(e) {
                  return (e.type.indexOf("key") || 67 === e.keyCode) &&
                    e.ctrlKey
                    ? e.shiftKey || e.altKey || e.metaKey
                      ? null
                      : (e.preventDefault(), t.sigint(e))
                    : null;
                }
              ]
            }
      ...
      G = {
        inject: ["setStdin"],
        props: {
          executed: { required: !0, type: Set },
          isSearch: { required: !0, type: Boolean },
          stdin: { required: !0, type: String }
        },
        data: function() {
      ...
      Q = G,
      X = (n("e589"), Object(y["a"])(Q, W, J, !1, null, null, null)),
      Y = X.exports,
      Z = function() {
        var t = this,
          e = t.$createElement,
        ...
        return n(
          ...
          [
            t._t("prompt", [
              t.hidePrompt
                ? t._e()
                : n("span", { staticClass: "term-ps" }, [
                    t._v(" " + t._s(t.local.prompt) + " ")
                  ])
            ]),
            n("span", { staticClass: "term-stdin" }, [
              n("input", {
                directives: [
                  {
                    ...
                    rawName: "v-model",
                    value: t.local.stdin,
                    expression: "local.stdin"
                  }
                ],
                ref: "input",
                attrs: {
                  autofocus: t.isLast,
                  disabled: !t.isLast || t.isInProgress,
                ...
                on: {
                  ...
                  input: function(e) {
                    e.target.composing ||
                      t.$set(t.local, "stdin", e.target.value);
                  }
                }
              })
            ])
    ...
    var rt = {
      ...
      ot = rt,
      it = (n("839b"), Object(y["a"])(ot, Z, tt, !1, null, null, null)),
      st = it.exports,
      ct = function() {
        var t = this,
          e = t.$createElement,
      ...
      at = [],
      ut = { props: { component: { required: !0, type: Object } } },
      lt = ut,
      ht = (n("836c"), Object(y["a"])(lt, ct, at, !1, null, null, null)),
      dt = ht.exports,
      ft = {
        provide: function() {
        ...
        methods: {
          autocomplete: function() {
            "function" === typeof this.autocompletionResolver &&
      ...
      wt = {
        autocomplete: function(t) {
          t.$refs["term-cont"].addEventListener("keydown", function(e) {
            e.keyCode !== _ ||
              t.local.isInProgress ||
              (e.preventDefault(), t.autocomplete());
          });
        },
        history: function(t) {
          t.$refs["term-cont"].addEventListener("keydown", function(e) {
            t.local.isInProgress ||
              (e.keyCode === P && (e.preventDefault(), t.decreaseHistory()),
              e.keyCode === S && (e.preventDefault(), t.increaseHistory()));
          });
        },
        search: function(t) {
          t.$refs["term-cont"].addEventListener("keydown", function(e) {
            e.ctrlKey &&
              e.keyCode === k &&
              !t.local.isInProgress &&
              (e.preventDefault(), t.setIsSearchHandler());
          });
        }
      };
    function Pt(t, e) {
    ...
    var At = {
      ...
      methods: {
        ...
        execute: function(t) {
          ...
          return Ct(
            u.a.mark(function n() {
              var r, o, i, s, c, a, l, h, d, f;
              return u.a.wrap(function(n) {
                while (1)
                  switch ((n.prev = n.next)) {
                    case 0:
                      (t = t.trim()),
                        (r = mt()(t.split(" "), e.parserOptions)._[0]),
                        (o = xt()),
                        (i = []),
                        (s = []),
                        (c = /[^\s"]+|"([^"]*)"/gi);
                      ...
                      return (
                        ...
                        (h = mt()(a, e.parserOptions)),
                        (n.next = 13),
                        Promise.resolve(e.commands[r](h))
                      );
                    case 13:
                      (o = n.sent),
                        (o = e.setupComponent(o, e.local.history.length, h)),
                        "" !== t &&
                          ((d = new Set(e.local.executed)),
                          d.delete(t),
                          d.add(t),
                          e.$emit("update:executed", d),
                          e.setExecuted(d)),
                        e.setPointer(e.local.executed.size),
                        (f = kt(e.local.history)),
                        f.push(o),
                        e.emitExecute(),
                        e.setIsInProgress(!0),
                        e.setHistory(f),
                        e.$emit("update:history", kt(f));
                    case 23:
                    case "end":
                      return n.stop();
                  }
        ...
        commandNotFound: function(t) {
          var e = xt();
          if ("" !== t) {
            (e = gt("".concat(t, ": ").concat(this.notFound), !0)),
              (e = this.setupComponent(e, this.local.history.length));
            var n = new Set(this.local.executed);
            n.delete(t),
              n.add(t),
              this.$emit("update:executed", n),
              this.setExecuted(n),
              this.setPointer(this.local.executed.size);
          }
          var r = kt(this.local.history);
          r.push(e),
            this.emitExecute(),
            this.setIsInProgress(!0),
            this.setHistory(r),
            this.$emit("update:history", kt(r));
        },
          ...
          var e = this,
            ...
            r =
              arguments.length > 2 && void 0 !== arguments[2]
                ...
                : {};
          (t = St({}, t)),
            hasOwnProperty.call(t, "computed") || (t.computed = {});
          var o = this.local.cursor,
            i = new Set(this.local.executed),
            s = kt(this.local.history),
            ...
            (t.computed = St(
              {
                environment: function() {
                  return {
                    isExecuting:
                      e.local.isInProgress && e.local.history.length - 1 === n,
                    isFullscreen: e.local.isFullscreen,
                    isInProgress: e.local.isInProgress
                  };
                },
                context: function() {
                  return {
        ...
        terminate: function() {
          this.setStdin(""),
            this.setIsFullscreen(!1),
            this.$emit("executed"),
            this.setIsInProgress(!1);
        }
      }
    };
    function Tt(t) {
      return Bt(t) || Ht(t) || Kt(t) || Lt();
    }
    function Lt() {
      throw new TypeError(
        "Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."
    ...
    var Mt = {
      ...
      watch: {
        history: function() {
          this.setHistory(Tt(this.history));
        },
      ...
      methods: {
        increaseHistory: function() {
          this.local.pointer < this.local.executed.size - 1 &&
            (this.local.pointer++,
            (this.local.stdin = Tt(this.local.executed)[this.local.pointer]));
        },
        decreaseHistory: function() {
          this.local.pointer > 0 &&
            (this.local.pointer--,
            (this.local.stdin = Tt(this.local.executed)[this.local.pointer]));
        },
    ...
    var Zt = new r["a"](),
      te = {
        components: { Search: Y, Stdin: st, Stdout: dt },
        mixins: [ft, At, Mt, zt, Vt],
        provide: function() {
          return {
        ...
        props: {
          ...
          eventListeners: {
            default: function() {
              return [wt.autocomplete, wt.history, wt.search];
            },
            type: Array
          },
          executed: {
          ...
          prompt: { default: "sjd@quantum:~", type: String },
          showHelp: { default: !1, type: Boolean },
          showIntro: { default: !1, type: Boolean },
          stdin: { default: "", type: String },
          title: { default: "sjd@quantum:~", type: String }
        },
        data: function() {
          return {
            bus: Zt,
        ...
        mounted: function() {
          ...
          (this.scroll.resizeObserver = new ResizeObserver(
                  ...
                  return u.a.wrap(function(e) {
                    while (1)
                      switch ((e.prev = e.next)) {
                        ...
                        case 2:
                          t.scroll.isBottom &&
                            (t.$refs["term-std"].scrollTop =
                              t.$refs["term-std"].scrollHeight);
                        case 3:
                        case "end":
                          return e.stop();
                      }
            ...
            (this.scroll.eventListener = function() {
              ...
              t.scroll.isBottom =
                e.scrollHeight - e.scrollTop - e.clientHeight === 0;
            }),
        ...
        created: function() {
          (this.executed.add = function() {
            for (
              ...
              r[o] = arguments[o];
            (t = this.local.executed).add.apply(t, r),
              (e = Object.getPrototypeOf(this).add).call.apply(
                e,
                [this].concat(r)
              );
          }),
            ...
            (this.executed.delete = function() {
              for (
                ...
                r[o] = arguments[o];
              (t = this.local.executed).delete.apply(t, r),
                (e = Object.getPrototypeOf(this).delete).call.apply(
                  e,
                  [this].concat(r)
                );
            }),
          ...
          0 === t.length &&
            ...
            this.$emit("update:history", Rt(t))),
            this.setHistory(Rt(t));
        },
        methods: {
      ...
      ee = te,
      ne = (n("590b"), Object(y["a"])(ee, R, U, !1, null, null, null)),
      re = ne.exports;
    function oe(t) {
      return ae(t) || ce(t) || se(t) || ie();
    }
    function ie() {
      throw new TypeError(
        "Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."
    ...
    var le = "sjd@quantum:~",
        ...
        data: function() {
          return {
            ...
            commands: {
              ...
              clear: void 0,
              echo: function(t) {
                return bt(JSON.stringify(t, null, 2));
              },
              help: function() {
                return bt(
              ...
              pokedex: function(t) {
                var e = t.color,
                  n = t._;
                return e && "pikachu" === n[1]
                  ? bt("yellow")
                  : gt(
                      "Usage: pokedex pokemon [option | -h]<br><br>\n\n          Example: pokedex pikachu --color\n        "
                    );
              },
              pwd: function() {}
            },
            ...
            history: [],
            options: {
              long: { pokedex: ["color"], loading: ["amount", "timeout"] },
              short: { pokedex: ["h"] }
            },
            prompt: le,
            stdin: ""
        ...
        created: function() {
          ...
          (this.commands.clear = function() {
            ...
            (this.commands.cd = function(e) {
              var n = e._;
              return ("home" !== n[1] && "home/" !== n[1]) || t.prompt !== le
                ? ("../" !== n[1] && ".." !== n[1]) ||
                  t.prompt !== "".concat(le, "home")
                  ? "." === n[1] || "./" === n[1] || "undefined" === typeof n[1]
                    ? xt()
                    : gt("cd: ".concat(n[1], ": No such file or directory"))
                  : ((t.prompt = le), xt())
                : ((t.prompt = "".concat(le, "home")), xt());
            }),
            (this.commands.pwd = function() {
              return "sjd@quantum:~" === t.prompt ? bt("/") : bt("/home");
            }),
            ...
            (this.autocompletionResolver = function() {
              var e = t.cursor,
                n = t.cursor,
                r = "";
              while (" " !== t.stdin[n - 1] && n - 1 > 0)
                n--, (r = "".concat(t.stdin[n]).concat(r));
              var o = t.stdin.split(" ");
              if (1 !== o.length) {
                if (
                  "" === t.stdin[e] ||
                  " " === t.stdin[e] ||
                  "undefined" === typeof t.stdin[e]
                ) {
                  var i = o[0];
                  if (
                    "undefined" !== typeof t.options.long[i] ||
                    "undefined" !== typeof t.options.short[i]
                  )
                    if ("--" !== r.substring(0, 2)) {
                      if ("-" === r.substring(0, 1)) {
                        var s = [];
                        if (
                          (t.options.short[i].forEach(function(t) {
                            ("-".concat(t).startsWith(r) || "-" === r) &&
                              s.push(t);
                          }),
                          1 === s.length)
                        ) {
                          var c = ""
                              .concat(t.stdin.substring(0, n - 1), " -")
                              .concat(s[0]),
                            ...
                            u = t.$watch(
                              ...
                              function() {
                                (t.cursor = e + (s[0].length - r.length + 1)),
                                  u();
                              }
                            );
                        ...
                        ("-" === r || s.length > 1) &&
                          t.history.push({
                            render: function(t) {
                              for (
                                var e = s.length < 5 ? s.length : 4,
                                  n =
                                    s.length < 5 ? 1 : Math.ceil(s.length / e),
                                  r = 0,
                                  o = [],
                                  i = 0;
                                i < n;
                                ...
                                for (var c = [], a = 0; a < e; a++)
                                  c.push(t("td", "-".concat(s[r]))), r++;
                                o.push(t("tr", [c]));
                              }
                              return t("table", { style: { width: "100%" } }, [
                                o
                              ]);
                            }
                          });
                      ...
                      var l = [];
                      if (
                        (t.options.long[i].forEach(function(t) {
                          ("--".concat(t).startsWith(r) || "--" === r) &&
                            l.push(t);
                        }),
                        1 === l.length)
                        ...
                        var h = ""
                          ...
                          f = t.$watch(
                            ...
                            function() {
                              (t.cursor = e + (l[0].length - r.length + 2)),
                                f();
                            }
                          );
                      ...
                      ("--" === r || l.length > 1) &&
                        t.history.push({
                          render: function(t) {
                            for (
                              var e = l.length < 5 ? l.length : 4,
                                n = l.length < 5 ? 1 : Math.ceil(l.length / e),
                                r = 0,
                                o = [],
                                i = 0;
                              i < n;
                ...
                var p = o[0],
                  m = [],
                  v = []
                    .concat(oe(Object.keys(t.commands)), ["reverse"])
                    .sort();
                if (
                  ...
                  "" !== t.stdin &&
                    ...
                    t.history.push({
                      render: function(t) {
                        for (
                          var e = m.length < 5 ? m.length : 4,
                            n = m.length < 5 ? 1 : Math.ceil(m.length / e),
                            r = 0,
                            o = [],
                            i = 0;
                          i < n;
                        ...
                        return t("table", { style: { width: "100%" } }, [o]);
                      }
                    }),
                  1 === m.length)
                ) {
                  var y = t.$watch(
                    ...
                    function() {
                      (t.cursor = e + (m[0].length - r.length + 0)), y();
                    }
                  );
                  t.stdin = m[0];
                }
      ...
      de = he,
      fe = (n("859e"), Object(y["a"])(de, o, i, !1, null, null, null)),
      pe = fe.exports;
...
//# sourceMappingURL=app.bad321fb.js.map
